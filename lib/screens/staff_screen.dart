                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(
                                      'Joined ${dateFormat.format(staff.joiningDate)} · ${currency.symbol}${staff.salary.toStringAsFixed(0)}/mo',
                                      style: TextStyle(
                                          fontSize: 12,
...
class _AddStaffSheetState extends State<_AddStaffSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<AppCurrency>(
      valueListenable: CurrencyController.instance.currency,
      builder: (context, currency, _) => Padding(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: 'Salary per month (${currency.symbol})'),
                  validator: (v) {
